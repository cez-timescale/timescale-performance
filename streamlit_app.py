...
# Set up tabs
hypertable_tab, compression_tab, continuous_aggregation_tab, pg_vector_tab, data_retention_tab = st.tabs(["Hypertable", "Compression", "Continuous Aggregation", "GenAI", "Data Retention"])
